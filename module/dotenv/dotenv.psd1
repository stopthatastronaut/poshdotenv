...
@{
    ...
    Author            = 'stopthatastronaut'

    # Company or vendor of this module
    CompanyName       = 'The DevOps Company (Australia)'
    ...
    FunctionsToExport = @('Push-DotEnv', 'Pop-DotEnv')
    ...
    AliasesToExport   = @('Set-DotEnv', 'Remove-DotEnv')
